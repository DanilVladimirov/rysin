"""
Django settings for rysin project.
...
SECRET_KEY = 'django-insecure-eck^dkek5&6m0)#b3+9x$uiib@50cn6)zk)30svis!elyq%20-'
...
WSGI_APPLICATION = 'rysin.wsgi.application'
